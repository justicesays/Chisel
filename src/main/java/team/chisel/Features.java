...
//    },
    ...
    GLASS {
        ...
        void addBlocks(ChiselBlockFactory factory) {
            ...
            factory.newBlock(Material.rock, "glass", provider).opaque(false).newVariation("a1-glasswindow-ironfencemodern").next("chrono").next("japanese").next("terrain-glass-chinese").next("terrain-glass-ornatesteel").next("terrain-glass-ornatesteel-old").next("terrain-glass-screen").next("terrain-glass-steelframe").next("terrain-glass-thickgrid").next("terrain-glass-thingrid").next("terrain-glassbubble").next("terrain-glassdungeon").next("terrain-glasslight").next("terrain-glassnoborder").next("terrain-glassshale").next("terrain-glassstone").next("terrain-glassstreak").build();
        }
    },
